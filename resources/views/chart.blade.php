<x-app-layout>
    ...
    @push('style')
        ...
        <script src="/dashboard_assets/js/charts-lines.js" defer></script>
        <script src="/dashboard_assets/js/charts-pie.js" defer></script>
        <script src="/dashboard_assets/js/charts-bars.js" defer></script>
    @endpush
</x-app-layout>
