<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    ...
    <!-- Mobile hamburger -->
    <button class="p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:ring-purple-300"
    ...
    <ul class="flex ml-auto items-center flex-shrink-0 space-x-6">
        <!-- Theme toggler -->
        <li class="flex">
        <button class="rounded-md focus:outline-none focus:ring-purple-300" @click="toggleTheme" aria-label="Toggle color mode">
            <template x-if="!dark">
        ...
        <!-- Notifications menu -->
        <li class="relative">
        <button class="relative align-middle rounded-md focus:outline-none focus:ring-purple-300" @click="toggleNotificationsMenu" @keydown.escape="closeNotificationsMenu"
        ...
        <!-- Profile menu -->
        <li class="relative">
        <button class="align-middle rounded-full focus:ring-purple-300 focus:outline-none" @click="toggleProfileMenu" @keydown.escape="closeProfileMenu"
            aria-label="Account" aria-haspopup="true">
            <img class="object-cover w-8 h-8 rounded-full" src="https://images.unsplash.com/photo-1502378735452-bc7d86632805?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&s=aa3a807e1bbdfd4364d1f449eaa96d82" alt=""
            aria-hidden="true"/>
        </button>
